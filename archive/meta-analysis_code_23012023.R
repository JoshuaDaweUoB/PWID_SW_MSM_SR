...
setwd("C:/Users/joshua.dawe/OneDrive - University of Bristol/Documents/Publications/Sex work and risk of HIV and HCV/code")
...
hiv_sw_roy <- read_excel("~/Sex work and risk of HIV and HCV/code/data/hiv data_roy.xlsx", sheet = "sex_work") # load data

hiv_sw_roy <- transform(hiv_sw_roy, cases = as.numeric(cases), 
...
hiv_sw_roy <- transform(hiv_sw_roy, effect_past_ln = log(effect_past),
...
hiv_sw_roy <- hiv_sw %>% slice(10:11) # subset of estimates

RR_HIV_sw_roy <- metagen(TE = effect_recent_ln,
                         ...
                         title = "RR comparing HIV incidence between sex work vs. no sex work in PWID",
                         text.random = "Overall")
summary(RR_HIV_sw_roy) # roy sex work

hiv_sw <- read_excel("~/Sex work and risk of HIV and HCV/code/data/hiv data.xlsx", sheet = "sex_work") # load data
...
update(RR_HIV_sw_recent, 
       subgroup = inci_publi_status, 
       tau.common = FALSE)
...
png(filename = "C:/Users/joshua.dawe/OneDrive - University of Bristol/Documents/Publications/Sex work and risk of HIV and HCV/code/plots/sw_recent.png", width = 28, height = 12, units = "cm",
    res = 500)
...
hiv_msm <- read_excel("~/Sex work and risk of HIV and HCV/code/data/hiv data.xlsx", sheet = "msm") # load data
hiv_msm <- read_excel("C:/Users/joshua.dawe/OneDrive - University of Bristol/Documents/Sex work and risk of HIV and HCV/code/data/hiv data.xlsx", sheet = "msm") # load data
...
hcv_sw <- read_excel("~/Sex work and risk of HIV and HCV/code/data/hcv data.xlsx") # load data
hcv_sw <- read_excel("C:/Users/joshua.dawe/OneDrive - University of Bristol/Documents/Sex work and risk of HIV and HCV/code/data/hcv data_spittal.xlsx") # load data
...
png(filename = "sw_recent_hcv.png", width = 28, height = 12, units = "cm",
    res = 500)
...
hcv_msm <- read_excel("C:/Users/joshua.dawe/OneDrive - University of Bristol/Documents/Sex work and risk of HIV and HCV/code/data/hcv data_spittal.xlsx", sheet = "msm") # load data
